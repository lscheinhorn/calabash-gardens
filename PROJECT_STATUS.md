...
- 2026-09-04: Connected `www.calabashgardens.com` to Firebase Hosting by replacing only its Namecheap CNAME with `calabash-54fb5.web.app`. Firebase reports the domain `Connected`, trusted HTTPS and clean routes are verified, and the prior GitHub Pages release remains intact as the rollback target.
