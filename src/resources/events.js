...

   {
    ...
    },
    {
     ...
     info: [
         ...
         `Local spirits with herbal infusion pairings or mocktails if preferred are included in this event.  All produce and meats featured are from some of our favorite local farms and Into the Wolf’s Mouth has full culinary creative license. Saffron from Calabash Gardens featured in each course 30 seats only, 50% non refundable deposit to secure your spot, 50% taken upon arrival at time of service. `
     ],
     // Date must be as follows: Date(year, month, day) format with month starting at index 0 for January
    ...
    },
    {
     ...
     info: [
         ...
         `Local spirits with herbal infusion pairings or mocktails if preferred are included in this event.  All produce and meats featured are from some of our favorite local farms and Cgad takes full culinary creative license. Saffron from Calabash Gardens featured in each course 30 seats only, 50% non refundable deposit to secure your spot, 50% taken upon arrival at time of service. `
     ],
     // Date must be as follows: Date(year, month, day) format with month starting at index 0 for January
