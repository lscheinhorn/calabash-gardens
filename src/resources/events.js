...
export const experienceBlurb = [
   ...
   `There are 30 seats available for each seating, Friday and Saturday nights for all Calabash Experiences in 2024. Gratuities are appreciated for our incredibly hard working staff, cash tips at time of service are split evenly between all function employees. We can accommodate vegetarians and gluten free for most of our meals, please hit the vegetarian or gluten free option when purchasing tickets. There is a $20 additional fee for the both options but if you pick noth, it is still just a $20 addition. We can not go gluten free in every Experience, please check the descriptions. If you are purchasing a mix bag of meat, veggie or gluten free, make sure you have picked the correct option before clicking buy tickets, and please check again once in the cart.`,
...
export const events = [
   ...
   },
   {
       ...
       category: "Experience",
       info: [
           `July 5th and 6th Calabash Will be hosting a unique Lao experience. Chefs Phet and Mary will be using saffron in a coursed out traditional Lao meal featuring incredible local ingredients and cocktail or mocktail pairings.`,
           `Meet your Chefs!`,
